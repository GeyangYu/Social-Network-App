...
public class UserListFFragment extends Fragment {
    static User USER;
    private static final String TAG = "UserListFFragment";
    ...
    public void updateUI() {
        ...
        List<User> users = mDb.getFavorite(mUserOwn);
